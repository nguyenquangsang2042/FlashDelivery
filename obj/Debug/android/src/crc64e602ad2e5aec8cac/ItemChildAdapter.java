...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("FlashDelivery.Present.Adapter.ItemChildAdapter, FlashDelivery", ItemChildAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == ItemChildAdapter.class)
			mono.android.TypeManager.Activate ("FlashDelivery.Present.Adapter.ItemChildAdapter, FlashDelivery", "", this, new java.lang.Object[] {  });
	}

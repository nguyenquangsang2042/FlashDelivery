...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("FlashDelivery.Present.Adapter.AdapterReport, FlashDelivery", AdapterReport.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == AdapterReport.class)
			mono.android.TypeManager.Activate ("FlashDelivery.Present.Adapter.AdapterReport, FlashDelivery", "", this, new java.lang.Object[] {  });
	}

...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("FlashDelivery.Present.Adapter.DashBoardAdapter, FlashDelivery", DashBoardAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == DashBoardAdapter.class)
			mono.android.TypeManager.Activate ("FlashDelivery.Present.Adapter.DashBoardAdapter, FlashDelivery", "", this, new java.lang.Object[] {  });
	}

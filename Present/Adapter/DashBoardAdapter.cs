...
{
    [Activity(Label = "DashBoardAdapter")]
    class DashBoardAdapter : RecyclerView.Adapter
    {
        ...
        private List<BeanItemDetails> itemchild;
        public DashBoardAdapter(MainActivity mainAct, List<BeanItemDetails> itemchild,bool isListShip=false)
        {
        ...
        class DashBoardViewHolder : RecyclerView.ViewHolder
        {
            ...
            public BeanItemDetails beanItemDetails { get;set;}
